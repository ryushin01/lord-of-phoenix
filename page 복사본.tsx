...
export default function MY_PR_002M() {
  ...
  /**
   * ㅇㅇㅇ
   * 행복전도회/행복추구회 사이비 교주 ㅇㅇ의 차남. 이복형이자 장남은 후계자로 지명되어 활동하다가 아버지와 같이 수감.
   * 경검 합작으로 경찰에게 잡혀 검찰에게 송치되어 교단 해체.
   * 유아기 때부터 아버지와 떨어져 살면서 경제적 지원을 받았으나, 경제적 지원이 끊기자 어머니가 집을 나가고 고아원에 맡겨짐.
   * 경제적 지원이 끊겨 인생 나락으로 떨어진 주인공의 복수행.
   * 해당 종교 단체는 전성기 시절 십 만 단위(?)의 신도를 보유했었음.
   * */
  const {
